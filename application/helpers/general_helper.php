...
{
$randomString = NULL;
$randomString = random_string($type, $length);
return $randomString;
}
...
function detail_actions($detail_id,$reference_number){
    $str = '';
    $str .= '<a href="/detail/editTransaction/'.$detail_id.'" class="btn default btn-xs black" ><i class="fa fa-pencil-square-o"></i> Edit</a><a href="/detail/generate_file/'.$reference_number.'" class="btn default btn-xs black" ><i class="fa fa-pencil-square-o"></i> Generate File</a>';
    return $str;
}
